...
const logInUser = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (userExists && (userExists === null || userExists === void 0 ? void 0 : userExists.password) !== data.password) {
    ...
    const accessToken = (0, jwtHelpers_1.createToken)(payloadData, config_1.default.secret, config_1.default.expires_in);
    const refreshToken = (0, jwtHelpers_1.createToken)(payloadData, config_1.default.refresh_secret, config_1.default.refresh_expires_in);
    return {
        refreshToken,
        accessToken,
    };
